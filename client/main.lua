...
package.cpath = "cmake-build-release/lib/lib?.so;cmake-build-debug/lib/lib?.so;cmake-build-relwithdebinfo/lib/lib?.so;cmake-build-relwithdebinfo/lib/lib?.dylib;cmake-build-release/lib/lib?.dylib"
jit.on()
